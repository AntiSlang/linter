...
- checkEnglish - включить / отключить 1 правило (по умолчанию включено)
- checkSpecials - включить / отключить 1 правило (по умолчанию включено)
- checkSensitive - включить / отключить 1 правило (по умолчанию включено)
